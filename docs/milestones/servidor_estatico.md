...
A Fundação construiu os alicerces. O Servidor Estático é onde o sistema começa a ter propósito observável.

Ao final deste milestone, o servidor não é um produto utilizável.

O que vem depois — CGI, uploads, features dinâmicas — será construído sobre um servidor que já sabe receber, rotear, responder e falhar com controle. Esse é o ponto de partida certo.
