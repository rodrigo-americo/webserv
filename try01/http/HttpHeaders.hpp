...
/*   Updated: 2026/06/10 23:19:42 by bruno-valer      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	{
		_set_cookie.push_back(key + "=" + value);
	}

	std::string	toString() const
	{
		std::string	resp = "Set-Cookie: ";
		for (size_t i = 0; i < _set_cookie.size(); i++)
		{
			resp += _set_cookie[i];
			if (i < _set_cookie.size() - 1)
				resp += "; ";
		}
		return resp;
	}
